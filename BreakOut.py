...
class Player(pygame.Rect):
    ...
    def draw(self):
        pygame.draw.rect(screen, 'orange', self, 0,border_radius=8) # fill
        pygame.draw.rect(screen, 'black', self, 1,border_radius=8)   # outline
...
class Brick(pygame.Rect):
    ...
    def draw(self):
        ...
        pygame.draw.rect(screen, 'black', self, 1, border_radius=8)
